...
public class InputLetterDto {
    ...
    public InputLetter toInputLetter() {
        ...
        if (documentType != null) inputLetter.setDocumentType(documentType.toDocumentType());
        if (origin != null) inputLetter.setOrigin(origin.toOriginAndAddress());
        if (signer != null) inputLetter.setSigner(signer.toParticipant());
        if (executor != null) inputLetter.setExecutor(executor.toParticipant());
        ...
        if (targetWorker != null) inputLetter.setTargetWorker(targetWorker.toWorker());
